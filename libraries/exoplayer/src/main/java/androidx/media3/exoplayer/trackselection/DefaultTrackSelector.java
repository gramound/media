...
public class DefaultTrackSelector extends MappingTrackSelector
  ...
  private static void maybeConfigureRenderersForTunneling(
    ...
    // Check whether we can enable tunneling. To enable tunneling we require:
    // - If allowVideoOnlyTunneling is false: exactly one audio and one video renderer to support
    //   tunneling and have a selection.
    // - If allowVideoOnlyTunneling is true: exactly one video renderer to support tunneling and
    //   have a selection.
